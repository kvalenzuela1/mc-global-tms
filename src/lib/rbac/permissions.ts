...
export const PERMISSIONS = {
  ...
  // Customers (shippers-as-customers + contacts + locations)
...
const MATRIX: Record<Role, Permission[]> = {
  [ROLES.ORG_ADMIN]: [
    ...
    PERMISSIONS.DOCUMENT_VIEW, PERMISSIONS.DOCUMENT_VERIFY, PERMISSIONS.INVOICE_CREATE,
  ...
  [ROLES.BROKER_DISPATCHER]: [
    ...
    PERMISSIONS.RATECON_SEND, PERMISSIONS.RATECON_VIEW,
    PERMISSIONS.MILESTONE_RECORD, PERMISSIONS.DOCUMENT_UPLOAD,
    PERMISSIONS.DOCUMENT_VIEW, PERMISSIONS.DOCUMENT_VERIFY,
  ],
